...
export class SyncEngine {
   ...
   */
  private async sendOperationToCloud(operation: SyncOperation): Promise<void> {
   ...
   */
  private shouldRetry(error: any, operation: SyncOperation): boolean {
  ...
  private async markOperationAsFailed(operation: SyncOperation): Promise<void> {
    // Loguear operación fallida para análisis posterior
    console.error('[SyncEngine] Operation failed permanently:', operation);
  }

  private async updateLocalItem(remoteItem: any): Promise<void> {
